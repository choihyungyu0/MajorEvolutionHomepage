...
11. 첫 교수 피칭은 기본 입력에서 주전공, 심층 입력에서 명시한 주전공·부전공·복수전공의 공식 소속 교수 한 명을 가까운 시작점으로 보여준다. 주제·방법 두 자리는 학과를 제한하지 않고 입력 고유어와 공식 연구분야·논문의 직접 근거를 우선해 제안하며, 학업 소속과 연구 적합성은 별도 근거로 설명한다.
...
| 교수 비교 | `/professors/pitch` | 학생 고민·공식 교수 정보 | 학업 소속 1명·학과 제한 없는 주제/방법 2명, `selectedProfessorId` | 대화 준비 허브 |
