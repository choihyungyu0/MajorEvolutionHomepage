...
- 실행 ID: `professors-2026-07-26T08-11-20-815Z`
- 범위 상태: **SAMPLE**
- 대학: 충북대학교
...
|---|---:|
| FOUND | 2 |
| NOT_LISTED_ON_OFFICIAL_PROFILE | 0 |
...
|---|---:|
| FOUND | 0 |
| NOT_LISTED_ON_OFFICIAL_PROFILE | 2 |
| PROFILE_UNAVAILABLE | 0 |
| PARSE_FAILED | 0 |
| ROBOTS_BLOCKED | 0 |
...
- **ROBOTS_BLOCKED** — https://www.cbnu.ac.kr/www/contents.do?key=391: Full-catalog discovery was not attempted: DISALLOW: / (영향: 중앙 호스트가 User-agent: * / Disallow: / 이므로 전체 학과 자동 발견 불가)
